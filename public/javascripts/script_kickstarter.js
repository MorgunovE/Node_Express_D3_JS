document.addEventListener('DOMContentLoaded', () => {
    ...
    // Load data
    d3.json('/data/kickstarter-funding-data.json')
        .then(data => {
            // Create hierarchy
            ...
            cell.append('rect')
                ...
                .on('mousemove', function(event, d) {
                    ...
                    tooltip
                        ...
                        .html(`
                            Nom: ${d.data.name}<br>
                            Catégorie: ${d.data.category}<br>
                            Montant: $${d.data.value.toLocaleString()}
                        `);
                })
        ...
        .catch(error => {
            console.error('Error loading Kickstarter data:', error);
